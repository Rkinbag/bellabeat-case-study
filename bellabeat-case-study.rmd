...
> ### To assist Bellabeat in improving the leaf, I would advice to use own tracking data for further analysis. Datasets used are small and can be biased as there are no demographic details of users. Knowing that our buyer persona are young and adult women I would encourage the finding of trends on own data to create a representative marketing strategy.
> 
> After our analysis we have found the following trends that may assist with marketing of the Leaf:
Error: unexpected symbol in "After our"
> 
...
> 
> Focus the marketing messages on higher activity improving sleep and lowering stress and on the fitness/losing weight aspects of the device. Highlighting the use of this device to track sleep and physical activity will encourage the user to increase activity and view improvement in their metrics.###
